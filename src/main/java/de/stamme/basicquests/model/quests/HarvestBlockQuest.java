    ...
    if (goal <= 1) {
      String singularName =
          MinecraftLocaleConfig.getMinecraftName(
              getOptionKey(), "block.minecraft.", "item.minecraft.");
      return MessageFormat.format(
          MessagesConfig.getMessage("quests.harvest-block.singular"), singularName);
    } else {
      String pluralName =
          MessagesConfig.getPluralName(
              getQuestType(), getOptionKey(), "block.minecraft.", "item.minecraft.");
      return MessageFormat.format(
          MessagesConfig.getMessage("quests.harvest-block.plural"), goal, pluralName);
    }
  }
