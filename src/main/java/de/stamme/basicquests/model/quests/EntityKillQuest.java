...
public class EntityKillQuest extends Quest {
  ...
  public String getName() {
    ...
    if (goal <= 1) {
      String singularName =
          MinecraftLocaleConfig.getMinecraftName(getOptionKey(), "entity.minecraft.");
      return MessageFormat.format(
          MessagesConfig.getMessage("quests.kill-entity.singular"), singularName);
    } else {
      String pluralName =
          MessagesConfig.getPluralName(getQuestType(), getOptionKey(), "entity.minecraft.");
      return MessageFormat.format(
          MessagesConfig.getMessage("quests.kill-entity.plural"), goal, pluralName);
    }
  }
