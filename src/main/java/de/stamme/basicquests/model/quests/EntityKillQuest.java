...
public class EntityKillQuest extends Quest {
	...
	public String getName() {
		...
		if (goal <= 1) {
			...
			return MessageFormat.format(MessagesConfig.getMessage("quest.killEntity.singular"), singularName);
		} else {
			String pluralName = MessagesConfig.getPluralName(getQuestType(), getOptionKey(), "entity.minecraft.");
			return MessageFormat.format(MessagesConfig.getMessage("quest.killEntity.plural"), goal, pluralName);
		}
	}
