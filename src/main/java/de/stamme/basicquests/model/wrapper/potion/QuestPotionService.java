...
public abstract class QuestPotionService {
    ...
    /**
     * @return the QuestPotionService that handles Structures correctly for the current spigot
    ...
    @Nullable
    public abstract ItemStack getPotionItemStack(Material material, String potionName, boolean extended, boolean upgraded);
}
