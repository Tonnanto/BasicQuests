...
public class QuestMaterialService_1_21 extends QuestMaterialService {
    ...
    public boolean isCorrectMaterialForQuest(Material questMaterial, Material blockMaterial) {
        return (questMaterial == blockMaterial || (questMaterial == Material.LAPIS_ORE && blockMaterial == Material.DEEPSLATE_LAPIS_ORE)
    ...
    public boolean isLogType(Material material) {
        return (material == Material.ACACIA_LOG || material == Material.BIRCH_LOG || material == Material.DARK_OAK_LOG || material == Material.JUNGLE_LOG
                || material == Material.OAK_LOG || material == Material.SPRUCE_LOG || material == Material.MANGROVE_LOG || material == Material.CHERRY_LOG);
    }
}
