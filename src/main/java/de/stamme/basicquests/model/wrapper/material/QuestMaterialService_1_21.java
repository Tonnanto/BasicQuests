...
public class QuestMaterialService_1_21 extends QuestMaterialService {
  ...
  public boolean isCorrectMaterialForQuest(Material questMaterial, Material blockMaterial) {
    return (questMaterial == blockMaterial
        ...
        || (questMaterial == Material.DIAMOND_ORE
            && blockMaterial == Material.DEEPSLATE_DIAMOND_ORE)
        || (questMaterial == Material.EMERALD_ORE
            && blockMaterial == Material.DEEPSLATE_EMERALD_ORE)
        || (questMaterial == Material.GOLD_ORE && blockMaterial == Material.DEEPSLATE_GOLD_ORE)
        || (questMaterial == Material.REDSTONE_ORE
            && blockMaterial == Material.DEEPSLATE_REDSTONE_ORE));
  }
