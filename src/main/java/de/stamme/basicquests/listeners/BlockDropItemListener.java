...
public class BlockDropItemListener implements Listener {
    ...
    private void handleHarvestBlockQuest(QuestPlayer questPlayer, BlockDropItemEvent event, HarvestBlockQuest quest) {
        ...
        if (harvestedMaterial == Material.SUGAR_CANE || harvestedMaterial == Material.BAMBOO || harvestedMaterial == Material.CACTUS
                || harvestedMaterial == Material.KELP_PLANT) {

            boolean isCorrectMaterial = quest.getMaterial() == harvestedMaterial
                    || (quest.getMaterial() == Material.KELP && harvestedMaterial == Material.KELP_PLANT);
        ...
        for (Item item : event.getItems()) {
            ...
            if (item.getItemStack().getType() != quest.getMaterial()) {
                continue;
            }
            ...
            if (harvestedMaterial != droppedBy) {
                // crop dropped from the wrong block (like a chest)
                break;
            }
