...
public class BreakBlockListener implements Listener {
  ...
  /**
   * Checks if the player has an active BlockBreakQuest with the according block. If so, updates the
   * quests progress.
   */
  @EventHandler
  ...
  private void handleMineBlockQuest(QuestPlayer questPlayer, Block block, MineBlockQuest quest) {
    ...
    boolean isCorrectMaterial =
        QuestMaterialService.getInstance()
            .isCorrectMaterialForQuest(quest.getMaterial(), block.getType());
