...
public class UpdateChecker {
  ...
  @Nullable private String newVersion;
  ...
  public static UpdateChecker getInstance() {
    if (instance == null) {
      instance =
          new UpdateChecker(BasicQuestsPlugin.getPlugin(), BasicQuestsPlugin.getSpigotMCID());
    }
    return instance;
  }
  ...
  public void notifyUser(CommandSender user) {
    ...
    user.sendMessage(
        ChatColor.GREEN + String.format("Version %s of BasicQuests is now available:", newVersion));
