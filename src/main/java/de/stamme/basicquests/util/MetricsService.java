...
public class MetricsService {
    ...
    public static void setUpMetrics() {
        ...
        metrics.addCustomChart(new SimplePie("playtime_factor", () -> df.format(Config.minPlaytimeFactor()) + " -> " + df.format(Config.maxPlaytimeFactor())
                + " (at " + df.format(Config.maxPlaytimeHours()) + " hours)"));
